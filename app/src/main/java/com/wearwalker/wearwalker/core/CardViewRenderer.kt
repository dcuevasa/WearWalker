...
internal object CardViewRenderer {
    internal fun render(
        ...
        return with(DeviceLcdRenderer) {
            ...
            val ownerIcon = decodeSprite(spriteData, CARD_OWNER_ICON, 16, 16)
            val ownerNameImage = decodeSprite(spriteData, CARD_OWNER_NAME, 80, 16)
            ...
            if (page == 0) {
                ...
                blit(frame, ownerIcon, 16, 16, 0, 16)
                blit(frame, ownerNameImage, 80, 16, 16, 16)
            ...
            LcdPreviewFrame(
                ...
                hasVisualContent =
                    hasNonBackground(title) ||
                        hasNonBackground(ownerNameImage) ||
