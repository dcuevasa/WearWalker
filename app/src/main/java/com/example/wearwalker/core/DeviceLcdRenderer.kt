...
object DeviceLcdRenderer {
    ...
    internal const val POKEBALL_8 = 0x0460
    internal const val POKEBALL_8_LIGHT = 0x0470
    ...
    internal const val TEXT_NO_POKE_HELD = 0x44B0
    ...
    internal const val TEXT_FIND_POKE = 0x4F30
    ...
    internal const val TEXT_THROW_POKEBALL = 0x5FB0
    internal const val TEXT_SWITCH = 0x8B30

    internal const val CARD_TRAINER_ICON = 0x1210
    ...
    internal const val SMALL_POKEMON = DeviceOffsets.WALK_POKEMON_SMALL_ANIM_OFFSET
    internal const val BIG_POKEMON = DeviceOffsets.WALK_POKEMON_BIG_ANIM_OFFSET
    internal const val WALKING_POKEMON_NAME = DeviceOffsets.WALK_POKEMON_NAME_SPRITE_OFFSET
    internal const val ROUTE_POKEMON_SPRITES = DeviceOffsets.ROUTE_POKEMON_SPRITES_OFFSET
    internal const val ROUTE_POKEMON0_NAME = DeviceOffsets.ROUTE_POKEMON_NAME_SPRITES_OFFSET
    internal const val ROUTE_ITEM0_NAME = DeviceOffsets.ROUTE_ITEM_NAME_SPRITES_OFFSET
    internal const val ROUTE_POKEMON_NAME_STRIDE = 0x140
