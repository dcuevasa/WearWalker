...
object DeviceOffsets {
    ...
    const val IDENTITY_TRAINER_NAME_OFFSET = IDENTITY_OFFSET + 72
    ...
    const val ROUTE_POKEMON_LIST_OFFSET = ROUTE_INFO_OFFSET + 82
    ...
    const val WALK_POKEMON_SMALL_ANIM_OFFSET = 0x91BE
    const val WALK_POKEMON_BIG_ANIM_OFFSET = 0x933E
    const val WALK_POKEMON_NAME_SPRITE_OFFSET = 0x993E
    const val ROUTE_POKEMON_SPRITES_OFFSET = 0x9A7E
    const val ROUTE_POKEMON_NAME_SPRITES_OFFSET = 0xA4FE
    const val ROUTE_ITEM_NAME_SPRITES_OFFSET = 0xA8BE

    const val TEAM_OFFSET = 0xCC00
    const val WATTS_FOR_REMOTE_OFFSET = 0xCE8A
    const val CAUGHT_POKEMON_OFFSET = 0xCE8C
    const val DOWSED_ITEMS_OFFSET = 0xCEBC
    const val GIFTED_ITEMS_OFFSET = 0xCEC8
    const val STEP_HISTORY_OFFSET = 0xCEF0

    const val POKEMON_SUMMARY_SIZE = 16
    const val ITEM_DATA_SIZE = 4
    const val POKEMON_SLOT_COUNT = 3
